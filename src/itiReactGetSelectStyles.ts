// THIS IS THE CURRENT CODE FROM ITI-REACT THAT WILL SERVE AS THE
// BASIS FOR THE NEW CODE.
...
export const getSelectStyles: GetSelectStyles = (
  ...
  function getSvgStyles(defaultDim: number): {
    width?: number;
    height?: number;
  } {
  ...
  return {
    ...
    dropdownIndicator: (base, props): CSSObject => {
      ...
      if (props.isDisabled) {
        styles.color = new Color(base.color)
